					...
					<div class="container bg-gris4">
						<div class="row">
							...
							<div class="col-4 d-flex justify-content-center">
								<span><b>Estado: </b><span class="enproceso">En proceso (2025-01-29)<!-- {{ getPlanById(props.planId).fecha_ult_actualizacion }} --></span></span>
							</div>
...
export default {
	...
	setup(props) {
		const getPlanById = (id) => {
			/* const storedPlanes = JSON.parse(localStorage.getItem("planes")) || [];
			const plan = storedPlanes.find((plan) => plan.id === Number(id));
			return plan || null; */
		};
