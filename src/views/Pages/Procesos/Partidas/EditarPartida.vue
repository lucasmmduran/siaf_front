<template>
<!--Modal 3 - Editar partida-->
<div class="modal fade" :id="'EditarPartida_'+partidaSeleccionada.id" tabindex="-1" aria-labelledby="EditarPartidaLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">

      <div class="modal-header border-gris d-flex justify-content-between align-items-start">
        <h6 class="montserrat fw-bold pb-4">Editar partida {{  partidaSeleccionada.id }}</h6>
